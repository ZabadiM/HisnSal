...
import { ChevronRight, Sun, Moon, CheckCircle2, BookOpen, RotateCcw, Edit2, Trash2, Plus } from 'lucide-react';
...
const SortableItem: any = ({ item, index, isEditMode, handleIncrement, setShowDeleteConfirm, showVirtueFor, setShowVirtueFor, getProgress }: any) => {
    const {
      attributes,
      listeners,
      setNodeRef,
